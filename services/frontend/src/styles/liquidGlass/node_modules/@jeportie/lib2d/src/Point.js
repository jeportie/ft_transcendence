...
export default class Point extends Coord {
    ...
    /**
     * Adds a scaled vector to this point without mutating it.
     * Equivalent to this.add(vector.scale(scale)).
     * @param {Vector} vector
     * @param {number} scale
     * @returns {Point} New point after translation
     */
    addScaled(vector, scale) {
        if (!(vector instanceof Vector))
            throw new TypeError("Point.addScaled requires a Vector object");
        return new Point(this.x + vector.x * scale, this.y + vector.y * scale);
    }

    /**
     * Adds a scaled vector to this point, mutating this point.
     * @param {Vector} vector
     * @param {number} scale
     * @returns {Point} This instance after translation
     */
    addScaledSelf(vector, scale) {
        if (!(vector instanceof Vector))
            throw new TypeError("Point.addScaledSelf requires a Vector object");
